...
public class EmployeeProfileIntegrationTest {
    ...
    void testManagerCanViewSpecificUserSensitiveAndPublicData() {
        ...
        var publicResponse =
                restTemplate.exchange(
                        ...
                        HttpMethod.GET,
                        coworkerEntity,
                        EmployeeSensitiveProfileDTO
                                .class // try to map it to a sensitive profile data
                        );
    ...
    void testLoginDoesNotWorkWithIncorrectPassword() {
        ...
        var responseWithWrongPass =
                restTemplate.postForEntity(AUTH_URL, authRequestWithWrongPass, Void.class);
    ...
    void testManagerCanViewSpecificUserAbsences() {
        ...
        var returnedAbsenceIds =
                sensitiveDto.getAbsences().stream()
    ...
    void testManagerCanViewSpecificEmployeeFeedbacks() {
        ...
        var feedback1 =
                createFeedback(
                        targetId,
                        manager.getId(),
                        "Feedback from Manager: Good job on the project.");
        var feedback2 =
                createFeedback(
                        targetId,
                        coworker.getId(),
                        "Feedback from Coworker: Need to improve communication.");
        ...
        var returnedFeedbackIds =
                sensitiveDto.getFeedbacks().stream()
